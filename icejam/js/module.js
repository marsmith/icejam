// module for exporting functions
...
//////////////////////////////////////////////////
export function img_link(string){
...
//////////////////////////////////////////////////
export function pop_home_imgs(site){
...
//////////////////////////////////////////////////
export function populate_api_images(site){
    // populate home image
    let image_div = nimsImageLinkJson[site].image_div
...
// call to assign urls from a click event
export function button_click_pop(){
...
var insert_js = `   <script src=\"../js/popout.js\" type=\"text/javascript\"> </script>
                ...
                `                
export function openWin(site_div, input=insert_js) {
    var popup;
    if (popup && !popup.closed) {
        ...
        var div_inner = document.getElementById(input)
        div_inner.insertAdjacentHTML('beforeend', insert_js )
