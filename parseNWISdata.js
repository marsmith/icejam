...
(function () {
    ...
    request(sitefileDataURL, (err, res, siteFileBody) => {
      ...
      request(qwDataURL, (err, res, qwBody) => {
          ...
          for (var j = 0; j < qwData.length; j++) { 
            ...
            if (siteFileData[i].site_no === qwData[j].site_no) {
              ...
              if (chlorideVal)  {
                ...
                qwData[j].fromNow = fromNow;

                feature.properties.measurements.push(qwData[j]);
                ...
                if (fromNow.indexOf('years ago') !== -1) {
                  ...
                  if (years < 10) {
                    if (!feature.properties.chloride10yearMax) feature.properties.chloride10yearMax = chlorideVal;
                    else if (chlorideVal > feature.properties.chloride10yearMax) feature.properties.chloride10yearMax = chlorideVal;
                  }
                  if (years >= 10 && years < 20) {
                    if (!feature.properties.chloride20yearMax) feature.properties.chloride20yearMax = chlorideVal;
                    else if (chlorideVal > feature.properties.chloride20yearMax) feature.properties.chloride20yearMax = chlorideVal;
                  }
                  if (years >= 20 && years < 30) {
                    if (!feature.properties.chloride30yearMax) feature.properties.chloride30yearMax = chlorideVal;
                    else if (chlorideVal > feature.properties.chloride30yearMax ) feature.properties.chloride30yearMax = chlorideVal;
                  }
                  if (years >= 30 && years < 40) {
                    if (!feature.properties.chloride40yearMax) feature.properties.chloride40yearMax = chlorideVal;
                    else if (chlorideVal > feature.properties.chloride40yearMax) feature.properties.chloride40yearMax = chlorideVal;
                  }
                  if (years >= 40 && years < 50) {
                    if (!feature.properties.chloride50yearMax) feature.properties.chloride50yearMax = chlorideVal;
                    else if (chlorideVal > feature.properties.chloride50yearMax) feature.properties.chloride50yearMax = chlorideVal;
                  }
                  if (years >= 50 && years < 60) {
                    if (!feature.properties.chloride60yearMax) feature.properties.chloride60yearMax = chlorideVal;
                    else if (chlorideVal > feature.properties.chloride60yearMax) feature.properties.chloride60yearMax = chlorideVal;
                  }
                  if (years >= 60 && years < 70) {
                    if (!feature.properties.chloride70yearMax) feature.properties.chloride70yearMax = chlorideVal;
                    else if (chlorideVal > feature.properties.chloride70yearMax) feature.properties.chloride70yearMax = chlorideVal;
                  }
                  if (years >= 70 && years < 80) {
                    if (!feature.properties.chloride80yearMax) feature.properties.chloride80yearMax = chlorideVal;
                    else if (chlorideVal > feature.properties.chloride80yearMax) feature.properties.chloride80yearMax = chlorideVal;
                  }
                  if (years >= 80 && years < 90) {
                    if (!feature.properties.chloride90yearMax) feature.properties.chloride90yearMax = chlorideVal;
                    else if (chlorideVal > feature.properties.chloride90yearMax) feature.properties.chloride90yearMax = chlorideVal;
                  }
        ...
        fs.writeFileSync('./dist/sitesGeoJSON.json', JSON.stringify(geoJSON));
      });
    });
})();
